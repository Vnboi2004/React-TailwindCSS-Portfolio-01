...
export const Signup = ({ setOpenPage }) => {
    ...
    return (
        <div className='h-screen w-screen fixed top-0 left-0 bg-black/50 z-50 backdrop-blur-sm'>
            <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white rounded-md duration-200 w-[520px] overflow-hidden'>
                <div className='absolute top-0 right-0 bg-primary/50 p-3 rounded-bl-full cursor-pointer'>
                ...
                <div className=''>
                    ...
                    <form className='flex flex-col gap-4 px-12'>
                        ...
                        <div className='flex flex-col gap-1'>
                            ...
                            <div className='relative'>
                                <input type={showPassword ? "text" : "password"} id='confirm-password' placeholder='At least 8 characters' className='w-full h-[42px] pl-2 outline-none border-[1px] border-gray-400/50 rounded-md'/>
                                {showPassword 
                                ? <PiEyeLight className='absolute top-1/2 -translate-y-1/2 right-2 text-[1.125rem] leading-[1.6rem] cursor-pointer' onClick={handleShowPasssword}/>
                                : <PiEyeSlash className='absolute top-1/2 -translate-y-1/2 right-2 text-[1.125rem] leading-[1.6rem] cursor-pointer' onClick={handleShowPasssword}/>}
                            </div>
                        ...
                        <button className='mt-2 py-[0.4rem] font-semibold bg-gradient-to-tr from-primary to-primary/30 rounded-md hover:scale-105 duration-300 transform'>Sign up</button>
                    </form>
